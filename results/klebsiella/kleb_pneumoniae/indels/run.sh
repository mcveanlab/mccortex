...
decomp_vcf $MCTXVCFS/breakpoints.joint.links.k31.k61.vcf.gz vcfs/breakpoints.vcf.gz
decomp_vcf $MCTXVCFS/bubbles.joint.links.k31.k61.vcf.gz vcfs/bubbles.vcf.gz
