...
#define seq_genome_hash_init() kh_init(kChromHash)
#define seq_genome_hash_destroy(genome) kh_destroy(kChromHash, genome)

static inline read_t* seq_fetch_chrom(const ChromHash *genome,
