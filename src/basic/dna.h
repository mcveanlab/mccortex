...
#define dna_char_to_nuc(c)  ({ ctx_assert2(char_is_acgtn(c),"%c",c), dna_char_to_nuc_arr[(unsigned char)(c)]; })
#define dna_char_complement(c) ({ ctx_assert2(char_is_acgtn(c),"%c",c), (char)dna_complement_char_arr[(unsigned char)(c)]; })
