...
extern const char dna_complement_char_arr[256];
...
#define char_is_acgt(c) (dna_char_to_nuc_arr[(unsigned char)(c)] < 4)
  ...
  #define dna_nuc_complement(n) (~(n) & 0x3)
#else
  ...
  #define dna_nuc_complement(n) ({ assert(((n)&3)==(n)), (~(n) & 0x3); })
#endif

#define dna_char_complement(c) dna_complement_char_arr[(unsigned char)(c)]
